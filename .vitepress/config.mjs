...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: "Scratch教程", link: "/project/scratch/index.md",
      },
      {
        text: "网站导航", link: "/project/daohang/index.md"
      },
      ...
      "/project/daohang/": [
        {
          ...
          collapsed: false,
          items: [
            { text: '文本工具', link: '/index.md' },
            { text: '图片工具', link: '/index.md' },
            { text: '音频工具', link: '/index.md' },
            { text: '视频工具', link: '/index.md' }
          ]
        }
      ],
